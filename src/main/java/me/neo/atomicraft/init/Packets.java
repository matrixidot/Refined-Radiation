...
import me.neo.atomicraft.networking.packet.EnergySyncS2C;
...
public class Packets {
    ...
    public static void register() {
        SimpleChannel net = NetworkRegistry.ChannelBuilder.named(new ResourceLocation(AtomiCraft.MOD_ID, "packets"))
